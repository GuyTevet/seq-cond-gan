...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='sanity', choices=['sanity','short','news_en_only','reddit'],
                        help='The name of dataset')
    parser.add_argument('--epoch', type=int, default=2, help='The number of epochs to run')
    parser.add_argument('--batch_size', type=int, default=64, help='The size of batch')
    parser.add_argument('--z_dim', type=int, default=512, help='Dimension of noise vector')
